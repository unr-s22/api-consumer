defmodule EmployeeConsumer.HumanResources do
  @moduledoc """
  ...
  def get_department_with_employees(id) do
    dept = Repo.get!(Department, id)
    employees = EmployeeConsumer.HumanResources.Employee.get_by_department(dept)
    Map.put(dept, :employees, employees)
  end
